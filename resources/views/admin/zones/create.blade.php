...
@section('page-title', 'Add New Zone')
@section('page-subtitle', 'Create a new zone for a city')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-50 p-8">
            <form action="{{ route('admin.zones.store') }}" method="POST">
                ...
                <div class="mb-6">
                    <label for="name" class="block text-sm font-semibold text-gray-700 mb-2">Zone Name</label>
                    <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Enter zone name..."
                ...
                <div class="mb-8">
                    ...
                    <p class="text-xs text-gray-400 mt-1 ml-7">Inactive zones won't appear in listings</p>
                </div>
