                ...
                <tbody>
                    @forelse($coupons as $coupon)
                        <tr class="table-row border-t border-gray-50">
                            <td class="py-3 px-4 text-sm text-gray-500">#{{ $coupon->id }}</td>
                            <td class="py-3 px-4 font-bold text-emerald-600">{{ $coupon->code }}</td>
                            <td class="py-3 px-4 text-sm text-gray-500">{{ ucfirst($coupon->discount_type) }}</td>
                            ...
                            <td class="text-center py-3 px-4">
                                <span
                                    class="badge {{ $coupon->is_active && $coupon->isValid() ? 'badge-confirmed' : 'badge-cancelled' }}">
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-16">
                                <div class="flex flex-col items-center">
                                    ...
                                    <h4 class="text-lg font-semibold text-gray-600">No coupons found</h4>
                                    <p class="text-sm text-gray-400 mt-0.5">Get started by creating your first coupon</p>
                                    <a href="{{ route('admin.coupons.create') }}"
