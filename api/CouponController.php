...
class CouponController extends Controller
{
     ...
     * Others: sees all coupons (read-only)
     */
     ...
     * This is the main method used when applying a coupon to a booking.
     */
    public function validateCoupon(ValidateCouponRequest $request): JsonResponse
    {
        ...
        $discountAmount = min($discountAmount, $totalAmount); // Cannot discount below zero
